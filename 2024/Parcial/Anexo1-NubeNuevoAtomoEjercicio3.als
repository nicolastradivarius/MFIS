/**
Anexo 1 Ejercicio 3
No puede definirse la signatura Archivo como unitaria, porque eso implicaría que sólo existe un átomo de
Archivo en todas las instancias del modelo, imposibilitando la dinámica de nuevo átomo.
Es necesario tener mínimamente dos átomos donde se refleje el cambio en las actualizaciones, y uno de esos
átomos va a tener un conjunto de actualizaciones distinta.

Ningún comando de éxito va a generar instancias.
*/
