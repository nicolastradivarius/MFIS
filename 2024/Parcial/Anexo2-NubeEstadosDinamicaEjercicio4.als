...
pred AplicarUltimaActualizacion[e1,e2: Estado] {
	...
	// poscondiciones
	// no se está teniendo en cuenta si la ultima actualización era prioritaria o era la única para decidir si
	// eliminar todas las actualizaciones pendientes o colocar alguna otra pendiente como ultima Actualizacion.
...
run aplicarUltimaActualizacionCasoExito {
	some e1, e2: Estado | AplicarUltimaActualizacion[e1, e2]
} for 7
