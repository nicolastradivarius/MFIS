...
// Eliminamos la multiplicidad de Archivo para que puedan existir multiples átomos
sig Archivo {
	// Movemos las relaciones del Estado al Archivo, y las hacemos ternarias para poder trackear cada
	// archivo en cada estado con sus actualizaciones correspondientes.
	actualizacionesPendientes: Estado -> set Actualizacion
	ultimaActualizacion: Estado one -> one Actualizacion
}
